        ...
        (this.holder = o(".qodef-swiper-container")),
          ...
          this.holder.length &&
            this.holder.each(function () {
              v.createSlider(o(this));
            });
      },
      createSlider: function (e) {
        var i = v.getOptions(e),
          t = v.getEvents(e);
      ...
      getOptions: function (e) {
        var i = void 0 !== e.data("options") ? e.data("options") : {},
          ...
          f =
            ...
            "" !== i.customStages &&
            i.customStages,
          c = void 0 !== i.outsideNavigation && "yes" === i.outsideNavigation,
          h = c
          ...
          f =
                ...
                : n < 5 && (g = n)),
            {
              ...
              spaceBetween: t,
              autoplay: (d =
                !1 !== d ? { delay: s, disableOnInteraction: !1 } : d),
              loop: a,
              speed: r,
              navigation: { nextEl: h, prevEl: c },
        ...
        return (
          l.length &&
            "fade" === l &&
            ((f.effect = "fade"), (f.fadeEffect = { crossFade: !0 })),
          Object.assign(f, v.getSliderDatas(e))
        );
      },
